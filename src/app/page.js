            ...
            <Card className="p-8">
              <CardContent className="text-center">
                <p className="text-lg text-muted-foreground leading-relaxed">
                  ...
                  profesionales. Me apasiona aprender continuamente, no solo
                  sobre tecnología, sino también sobre diversos aspectos de la
                  vida.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mt-4">
                  Me enfoco en el desarrollo web y de software, creando
                  soluciones digitales eficientes, escalables y orientadas al
                  usuario. Disfruto colaborar con otras personas, compartir
                  conocimientos y trabajar en equipo para alcanzar objetivos en
                  común.
                </p>
                <p className="text-lg text-muted-foreground leading-relaxed mt-4">
